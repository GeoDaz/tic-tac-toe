...
class TicTacToe:
    ...
    def minimaxWithAB(self, depth, isMax, alpha=-inf, beta=inf):
        ...
        for cell in self.empty_cells():
            ...
            # Permet de la faire gagner plus vite si deux victoires sont possibles mais elle défend moins bien
            # if self.evaluate(self.__board) >= max(250, 1000):
            #     best = [x, y, COMP]
            #     board[x][y] = 0
            #     break

            score = self.minimaxWithAB(depth - 1, not isMax, alpha, beta)
